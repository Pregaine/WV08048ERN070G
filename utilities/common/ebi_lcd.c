...
//#endif
	...
	EBI_InitStructure.EBI_WriteSetupTime = 0;
	EBI_InitStructure.EBI_WriteStrobeTime = 0;
	EBI_InitStructure.EBI_WriteHoldTime = 0;
#else
	EBI_InitStructure.EBI_WriteSetupTime = 0;
	EBI_InitStructure.EBI_WriteStrobeTime = 0;
	EBI_InitStructure.EBI_WriteHoldTime = 0;
	...
	EBI_InitStructure.EBI_ReadSetupTime = 0;
	EBI_InitStructure.EBI_ReadStrobeTime = 0;
	EBI_InitStructure.EBI_ReadHoldTime = 0;
