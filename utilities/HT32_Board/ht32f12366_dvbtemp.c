/*********************************************************************************************************//**
 * @file    ht32f12366_dvbtemp.c
 * @version $Rev:: 117          $
 * @date    $Date:: 2016-06-03 #$
 * @brief   This file provides firmware functions to manage LEDs, push-buttons
 *          and COM ports and is available on ht32f12366_dvbtemp Development Board.
 *************************************************************************************************************
 * @attention
 *
...
/** @defgroup HT32F12366_DVBTEMP HT32F12366_DVBTEMP
  * @brief Provides firmware functions to manage LEDs, push-buttons
  *        and COM ports and is available on HT32F12366 Development Board.
  * @{
  */


/* Private types -------------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_DVB_Private_TypesDefinitions HT32F1656 DVB private types definitions
  * @{
  */
...
/* Global variables ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F12366_DVBTEMP_Global_Variable HT32F12366 DVB global variables
  * @{
  */
...
/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F12366_DVBTEMP_Global_Functions HT32F12366 DVB global functions
  * @{
  */
/*********************************************************************************************************//**
...
void HT32F_DVB_PBInit(BUTTON_TypeDef Button, BUTTON_MODE_TypeDef Button_Mode)
{
  ...
  else if (Button_Mode == BUTTON_MODE_WEAK_UP)
  {
...
/* Private functions ---------------------------------------------------------------------------------------*/
/** @defgroup HT32F12366_DVBTEMP_Private_Functions HT32F12366 DVB private functions
  * @{
  */
/*********************************************************************************************************//**
