...
/** @addtogroup HT32F12365_66 HT32F12365/12366
  * @{
  */


#ifndef __HT32F12365_66_H__
#define __HT32F12365_66_H__
...
#include "system_ht32f12365_66.h"      /* HT32 system                                                       */
...
typedef struct
{
  ...
  __IO uint32_t TRANMODE;        /*!< 0x00C    Transfer Mode Register                                       */
  ...
  __IO uint32_t BLKGAPCTRL;      /*!< 0x030    Block Gap Register                                           */
  __IO uint32_t WAKEUPCTRL;      /*!< 0x034    Wake Up Control Register                                     */
  __IO uint32_t CLKCR;           /*!< 0x038    Clock Control Register                                       */
  __IO uint32_t TIMEOUT;         /*!< 0x03C    Timeout Register                                             */
