...
#ifndef __ht32f12365_66_SDIO_H
#define __ht32f12365_66_SDIO_H
...
#define IS_SDIO_FLAG(FLAG)              (((FLAG) != 0) && (((FLAG) & 0x003B00FB) != 0))
/**
  * @}
  */
...
/** @defgroup SDIO_Interrupt_sources SDIO Interruptsources
  * @{
  */
...
#define IS_SDIO_INT(INT)                (((INT) != 0) && (((INT) & 0x003B00FB) != 0))
/**
  * @}
  */
