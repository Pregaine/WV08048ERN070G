...
/* SD clock freq                                                                                            */
///*
#define SDIO_INIT_CLK_DIV               ((u32)(SystemCoreClock/1600000))//600000,1600000
#define SDIO_HIGH_SPEED_CLK_DIV         ((u32)3)
#define SDIO_NORMAL_SPEED_CLK_DIV       ((u32)30)//5,30
//*/
/*
#define SDIO_INIT_CLK_DIV               ((u32)(SystemCoreClock/600000))//600000,1600000
#define SDIO_HIGH_SPEED_CLK_DIV         ((u32)3)
#define SDIO_NORMAL_SPEED_CLK_DIV       ((u32)5)//5,30
*/
/* Private variables ---------------------------------------------------------------------------------------*/
