...
#include "ht32f12365_66_usbdchk.h"
...
static HT_USBEP_TypeDef * _USBD_GetEPTnAddr(USBD_EPTn_Enum EPTn);
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTInit(USBD_EPTn_Enum EPTn, u32 *pDriver)
{
  USBD_Driver_TypeDef *pDrv = (USBD_Driver_TypeDef *)pDriver;
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);

  USBEPn->CFGR = pDrv->ept[EPTn].CFGR.word;
  USBEPn->IER  = pDrv->ept[EPTn].IER;
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTReset(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTEnableINT(USBD_EPTn_Enum EPTn, u32 INTFlag)
{
  _USBD_GetEPTnAddr(EPTn)->IER = INTFlag;
  return;
}
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTGetINT(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  u32 IER = USBEPn->IER;
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTClearINT(USBD_EPTn_Enum EPTn, u32 INTFlag)
{
  _USBD_GetEPTnAddr(EPTn)->ISR = INTFlag;
  return;
}
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTGetHalt(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTSendSTALL(USBD_EPTn_Enum EPTn)
{
  _USBD_GetEPTnAddr(EPTn)->CSR = STLTX;
  return;
}
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTSetHalt(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTClearHalt(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTWaitSTALLSent(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  USBD_EPTCFGR_Bit *CFGR = (USBD_EPTCFGR_Bit *)(&(USBEPn->CFGR));
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void USBD_EPTClearDTG(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTGetBuffer0Addr(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTGetBuffer1Addr(USBD_EPTn_Enum EPTn)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  return (HT_USB_SRAM_BASE + (USBEPn->CFGR & EPBUFA_MASK) + USBD_EPTGetBufferLen(EPTn));
}
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTGetBufferLen(USBD_EPTn_Enum EPTn)
{
  return ((_USBD_GetEPTnAddr(EPTn)->CFGR & EPLEN_MASK) >> 10);
}
...
/*********************************************************************************************************//**
  ...
  * @param  EPTn: USB Endpoint number
  *         @arg USBD_EPT0 ~ USBD_EPT7
  * @param  type: USBD_TCR_0 or USBD_TCR_1
  * @retval Endpoint Transfer Count
  ***********************************************************************************************************/
u32 USBD_EPTGetTransferCount(USBD_EPTn_Enum EPTn, USBD_TCR_Enum type)
{
  return (((_USBD_GetEPTnAddr(EPTn)->TCR) >> type) & TCR_MASK);
}
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTWriteINData(USBD_EPTn_Enum EPTn, u32 *pFrom, u32 len)
{
  u32 bufferlen = USBD_EPTGetBufferLen(EPTn);
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  u32 EPTnLen;
  u32 *pTo;

  EPTnLen = (EPTn == USBD_EPT0) ? USBD_EPTGetTransferCount(EPTn, USBD_CNTIN):USBD_EPTGetTransferCount(EPTn, USBD_CNTB0);

  if (len <= bufferlen && EPTnLen == 0)
  {
    pTo = (u32 *)USBD_EPTGetBuffer0Addr(EPTn);
...
/*********************************************************************************************************//**
  ...
  ***********************************************************************************************************/
u32 USBD_EPTReadOUTData(USBD_EPTn_Enum EPTn, u32 *pTo, u32 len)
{
  HT_USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  u32 EPTnLen = 0;
  ...
  if (len != 0)
  {
    EPTnLen = USBD_EPTReadMemory(EPTn, pTo, len);
  }
...
/*********************************************************************************************************//**
  ...
  * @retval Total length read by this function
  ***********************************************************************************************************/
u32 USBD_EPTReadMemory(USBD_EPTn_Enum EPTn, u32 *pTo, u32 len)
{
  u32 EPTnLen = 0;
  u32 *pFrom;

  EPTnLen = (EPTn == USBD_EPT0) ? USBD_EPTGetTransferCount(EPTn, USBD_CNTOUT):USBD_EPTGetTransferCount(EPTn, USBD_CNTB0);

  if (EPTnLen <= len)
  {
    pFrom = (EPTn == USBD_EPT0) ? (u32 *)USBD_EPTGetBuffer1Addr(EPTn):(u32 *)USBD_EPTGetBuffer0Addr(EPTn);
...
static HT_USBEP_TypeDef * _USBD_GetEPTnAddr(USBD_EPTn_Enum EPTn)
{
  return ((HT_USBEP_TypeDef *)(HT_USBEP0 + EPTn));
}
