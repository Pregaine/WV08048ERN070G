...
#define CKCU_BB_REFCLKSEL       BitBand((u32)&HT_CKCU->HSICR, 5)
 ...
 *        This parameter can be:
 *        @arg CKCU_PCLK_I2C0,  CKCU_PCLK_I2C1,  CKCU_PCLK_SPI0,   CKCU_PCLK_SPI1,
 *             CKCU_PCLK_BFTM0, CKCU_PCLK_BFTM1, CKCU_PCLK_MCTM0,  CKCU_PCLK_MCTM1,
 *             CKCU_PCLK_GPTM0, CKCU_PCLK_GPTM1, CKCU_PCLK_USART0, CKCU_PCLK_USART1,
 *             CKCU_PCLK_UART0, CKCU_PCLK_UART1
 *             CKCU_PCLK_AFIO,  CKCU_PCLK_EXTI,  CKCU_PCLK_ADC,    CKCU_PCLK_CMP,
 *             CKCU_PCLK_WDTR,  CKCU_PCLK_BKPR,  CKCU_PCLK_SCI,    CKCU_PCLK_I2S
...
u32 CKCU_GetPeripFrequency(CKCU_PeripPrescaler_TypeDef Perip)
{
  ...
  return (Clocks.HCLK_Freq >> (PCLKPrescaler));
}
 ...
 *             CKCU_DBG_I2C0_HALT,  CKCU_DBG_I2C1_HALT,  CKCU_DBG_SCI0_HALT,   CKCU_DBG_SCI1_HALT,
