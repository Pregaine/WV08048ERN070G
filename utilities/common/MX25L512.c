...
void MX25L512_PageWrite( u8* WriteBuffer, u32 WriteAddr, u32 NumOfWriteByte );

void MX25L512_Test( void )
{
	u32 i, err = 0, result;
	...
	{
		/*  Turn on LED2 */
		printf( "\r\nMX25L512 Write/Read Pass" );
	}
	else
	{
		printf( "\r\nMX25L512 Write/Read Fault, %d", err );
	}
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void MX25L512_BufferWrite( u8* WriteBuffer, u32 WriteAddr, u32 NumOfWriteByte )
{
  int i;
