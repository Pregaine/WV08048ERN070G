...
#ifndef __HT32F12365_66_USART_H
#define __HT32F12365_66_USART_H
...
#define IS_USART_INT(INT) (((INT & 0xFFFFFC00) == 0x0) && (INT != 0x0))
/**
  * @}
  */
...
#define IS_USART_FIFO_DIRECTION(DIRECTION)            (((DIRECTION & 0xFFFFFFFC) == 0x0) && (DIRECTION != 0x0))
...
#define IS_USART(USART) ((USART == HT_USART0) || (USART == HT_UART0) || (USART == HT_UART1))
