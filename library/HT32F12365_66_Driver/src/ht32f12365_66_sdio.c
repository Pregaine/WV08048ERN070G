...
void SDIO_DataConfig(SDIO_DataInitTypeDef* SDIO_DataInitStruct)
{
  ...
  HT_SDIO->TRANMODE = SDIO_DataInitStruct->SDIO_TransferMode | SDIO_DataInitStruct->SDIO_TransferDir;
  HT_SDIO->TIMEOUT = SDIO_DataInitStruct->SDIO_DataTimeOut;
}
...
/*********************************************************************************************************//**
  ...
  *         @arg SDIO_FLAG_CMD_CRCFAIL:
  *         @arg SDIO_FLAG_CMD_INDEXFAIL:
  *         @arg SDIO_FLAG_DATA_TIMEOUT:
  *         @arg SDIO_FLAG_DATA_CRCFAIL:
...
/*********************************************************************************************************//**
  * @brief  Enable or Disable SDIO's interrupt.
  ...
  *         @arg SDIO_INT_CMD_CRCFAIL:
  *         @arg SDIO_INT_CMD_INDEXFAIL:
  *         @arg SDIO_INT_DATA_TIMEOUT:
  *         @arg SDIO_INT_DATA_CRCFAIL:
  * @param  NewState: This parameter can be ENABLE or DISABLE.
  * @return SET or RESET
  ***********************************************************************************************************/
