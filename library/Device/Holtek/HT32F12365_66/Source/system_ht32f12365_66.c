/**************************************************************************//**
 * @file    library/Device/Holtek/HT32F12365_66/Source/system_ht32f12365_66.c
...
/** @addtogroup HT32F12365_66_system HT32F12365/12366 System
  * @{
  */
...
/** @addtogroup HT32F12365_66_System_Private_Defines
  * @{
  */
/*
...
//        <o4>  PLL Feedback Clock Divider (NF2): 1 ~ 32
//                <1-32:1>
...
#define WAIT_STATE        (4)     /*!< 0: WS = 0,   1: WS = 1, 2: WS = 2, 3: WS = 3,  4: WS = AUTO          */
 ...
 */
  ...
  #if ((__CK_VCO < 64000000) || (__CK_VCO > 96000000))
    #error "CK_VCO clock issue: must be in the range of 64 MHz to 96 MHz!"
  #endif

  #define __CK_PLL    (__CK_VCO >> PLL_NO2_DIV)                 /*!< Get CK_PLL frequency                   */

  /* Check CK_PLL frequency                                                                                 */
  #if ((__CK_PLL < 8000000UL) || (__CK_PLL > 96000000UL))
    #error "CK_PLL clock issue: must be in the range of 8 MHz to 96 MHz!"
  #endif
#endif
...
#if ((__CK_AHB < 250000UL) || (__CK_AHB > 96000000UL))
  #error "CK_AHB clock issue: must be in the range of 250 KHz to 96 MHz!"
#endif
...
/** @addtogroup HT32F12365_66_System_Private_Variables
  * @{
  */
...
/** @addtogroup HT32F12365_66_System_Private_Functions
  * @{
  */
...
void SystemInit (void)
{
  ...
  CKCU_PLLCFGR = ((PLL_NF2_DIV & 0x1F) << 23) | (PLL_NO2_DIV << 21);  /* set PLL divider                    */
  ...
  /* CK_AHB initiation                                                                                      */
    ...
    FLASH_CFCR = (((FLASH_CFCR) & ~7UL) | 4UL);                   /* auto-select wait state                 */
  #elif (__CK_AHB > 48000000UL)
    FLASH_CFCR = (((FLASH_CFCR) & ~7UL) | 3UL);                   /* auto-select wait state                 */
  #elif (__CK_AHB > 24000000UL)
    FLASH_CFCR = (((FLASH_CFCR) & ~7UL) | 2UL);                   /* auto-select wait state                 */
  #endif
#else
  FLASH_CFCR = (((FLASH_CFCR) & ~7UL) | (WAIT_STATE + 1));        /* manual wait state                      */
#endif
...
#if (HCLK_SRC != 3)
  CKCU_GCCR = ((CKCU_GCCR & ~3UL) | HCLK_SRC);                    /* select CK_SYS source                   */
  while (((CKCU_CKST) & 7UL) != HCLK_SRC);                        /* wait for clock switch complete         */
#endif
