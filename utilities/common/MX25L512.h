 ...
 * @brief   The header file of MX25L512.
 *************************************************************************************************************
 * @attention
 *
...
/** @defgroup SPI_FLASH_AUTO_Exported_Functions SPI_FLASH_AUTO exported functions
  * @{
  */
extern void MX25L512_PageWrite( unsigned char* WriteBuffer, unsigned int WriteAddr, unsigned int NumOfWriteByte );
extern void MX25L512_BufferWrite( unsigned char* WriteBuffer, unsigned int WriteAddr, unsigned int NumOfWriteByte );
extern void MX25L512_Test( void );
/**
  * @}
  */
